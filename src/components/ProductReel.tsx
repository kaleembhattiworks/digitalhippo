...
export default function ProductReel(props: ProductReelProps) {
	...
	return (
		<section className="py-12 px-2.5 md:px-0">
			<div className="md:flex md:items-center md:justify-between mb-4">
				<div className="max-w-2xl lg:max-w-4xl text-center xs:text-left">
			...
			<div className="relative">
				<div className="mt-6 flex items-center w-full">
					<div
						className={cn(
							'w-full grid grid-cols-1 gap-x-4 gap-y-10 xs:grid-cols-2 sm:gap-x-6 md:grid-cols-4 md:gap-y-10 lg:gap-x-8'
						)}
					>
						{map.map((product, i) => (
